...
export function ExpandableCardGridDemo() {
  ...
  return (
    <>
      ...
      <ul className="max-w-[55vw] mx-auto w-full grid grid-cols-1 md:grid-cols-3 items-start gap-4">
          ...
          >
            <div className="flex gap-4 flex-col  w-full">
              <motion.div layoutId={`image-${card.title}-${id}`}>
                <Image width={200} height={200} src={card.src} alt={card.title} className="h-60 w-full  rounded-lg object-cover object-top" />
              </motion.div>
